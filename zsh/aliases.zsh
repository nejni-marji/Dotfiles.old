...
alias data='du -hs * 2>/dev/null | sort -hr'
...
# mpc
# needs a wrapper function, but for now this alias will let me call up this
# for reference fairly easily
MPC_STCUR='mpc sticker "$(mpc -f %file% current)"'
alias mpc_rate="$MPC_STCUR"
